    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListHeaderComponent={
            viewRole === 'admin' ? <><AtlasShell role="admin" activeProjectId={activeProjectId} activeProjectName={activeProject?.name} /><PortfolioSummaryWidget /><MyDaySection viewRole="admin" /><ManagementCreCards projectId={activeProjectId} /></> :
            viewRole === 'pm' ? <><AtlasShell role="pm" activeProjectId={activeProjectId} activeProjectName={activeProject?.name} />{activeProjectId && <ContinueWorkingCta projectId={activeProjectId} router={router} />}<MyDaySection viewRole="pm" /><PmCreCards projectId={activeProjectId} /></> :
            viewRole === 'supervisor' ? <><AtlasShell role="supervisor" activeProjectId={activeSite?.project_id || null} activeProjectName={activeSite ? projectMap[activeSite.project_id]?.name || null : null} /><SupervisorHomeHeader router={router} siteName={activeSite?.name || null} projectName={activeSite ? projectMap[activeSite.project_id]?.name || null : null} /></> :
            null
          }
